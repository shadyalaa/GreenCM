	...
	while(running) {
		...
		*/
		...
		for (cpu = 0; cpu < cpus; cpu++) {
			...
			else if(average < 1700000){
				freqmonitor[cpu][1] += 1;
			}
			else if(average < 1900000){
				freqmonitor[cpu][2] += 1;
			}
			else if(average < 2100000){
				freqmonitor[cpu][3] += 1;
			}
			else if(average < 2400000){
				freqmonitor[cpu][4] += 1;
			}
			else if(average < 2600000){
				freqmonitor[cpu][5] += 1;
			}
			else{
				freqmonitor[cpu][6] += 1;
